...
public class MonsterListPagerFragment extends BasePagerFragment {
    ...
    @BindString(R.string.monsters_list_tab_large)
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(R.string.monsters_list_title));
    }
}
